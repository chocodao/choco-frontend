                ...
                {!hasAllowance() && !useAvax && (
                    <div className="help-text">
                        <p className="help-text-desc">
                            Note: The "Approve" transaction is only needed when melting for the first time; subsequent melting only requires you to perform the "Melt" transaction.
                        </p>
                    </div>
                )}
            </Box>
            ...
            <Slide direction="left" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
                <Box className="bond-data">
                    ...
                    <div className="data-row">
                        ...
                        <p className="bond-balance-title">0.01 BARS</p>
                    </div>
                </Box>
            </Slide>
