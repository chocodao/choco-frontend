...
function TimeMenu() {
    ...
    const WTFUEL_ADDRESS = addresses.WTFUEL_ADDRESS;
                    ...
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link
                                ...
                                href={`https://thetaswap.io/swap?tokenAddressInput=${WTFUEL_ADDRESS}&tokenAddressOutput=${TIME_ADDRESS}`}
                                target="_blank"
                            >
                                <p>Trade on Theta Swap</p>
                            </Link>
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("BARS", TIME_ADDRESS)}>
                                        <p>BARS</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("WRPR", MEMO_ADDRESS)}>
                                        <p>WRPR</p>
                                    </div>
                                </div>
                            )}
